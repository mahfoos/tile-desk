...
export class WidgetHomeComponent implements OnInit, OnChanges {
  ...
  public defaultFooter = '<a tabindex="-1" target="_blank" href="https://neura.ascii.ai/"><img src="https://res.cloudinary.com/dxw9gnkom/image/upload/v1701367350/elitecx/smynayibsfdibtycgsw9.png"/><span>Powered by EliteCX</span></a>'
