  ...
  getCurrentTranslation(selectedLangCode: string) {
    ...
    this.translations.forEach(translation => {
      if (translation.lang.toLowerCase() === selectedLangCode) {
        ...
        console.log("Welcome Title", this.welcomeTitle)
    ...
    this.projectService.getProjectById(this.id_project).subscribe((project: any) => {
      ...
      if (project.widget) {
        ...
        if (project.widget.poweredBy) {
          ...
          this.footerBrand = '<a tabindex="-1" target="_blank" href="https://neura.ascii.ai/"><img src="https://res.cloudinary.com/dxw9gnkom/image/upload/v1701367350/elitecx/smynayibsfdibtycgsw9.png"/><span>Powered by EliteCX</span></a>';
        }
